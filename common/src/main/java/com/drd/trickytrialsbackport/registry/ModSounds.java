...
public class ModSounds {
    ...
    public static Supplier<SoundEvent> VAULT_ACTIVATE;
    public static Supplier<SoundEvent> VAULT_AMBIENT;
    public static Supplier<SoundEvent> VAULT_BREAK;
    public static Supplier<SoundEvent> VAULT_CLOSE_SHUTTER;
    public static Supplier<SoundEvent> VAULT_DEACTIVATE;
    public static Supplier<SoundEvent> VAULT_EJECT_ITEM;
    public static Supplier<SoundEvent> VAULT_FALL;
    public static Supplier<SoundEvent> VAULT_HIT;
    public static Supplier<SoundEvent> VAULT_INSERT_ITEM;
    public static Supplier<SoundEvent> VAULT_INSERT_ITEM_FAIL;
    public static Supplier<SoundEvent> VAULT_OPEN_SHUTTER;
    public static Supplier<SoundEvent> VAULT_PLACE;
    public static Supplier<SoundEvent> VAULT_REJECT_REWARDED_PLAYER;
    public static Supplier<SoundEvent> VAULT_STEP;
    ...
    public static void register() {
        ...
        VAULT_ACTIVATE = registerSound(helper, "block.vault.activate");
        VAULT_AMBIENT = registerSound(helper, "block.vault.ambient");
        VAULT_BREAK = registerSound(helper, "block.vault.break");
        VAULT_CLOSE_SHUTTER = registerSound(helper, "block.vault.close_shutter");
        VAULT_DEACTIVATE = registerSound(helper, "block.vault.deactivate");
        VAULT_EJECT_ITEM = registerSound(helper, "block.vault.eject_item");
        VAULT_FALL = registerSound(helper, "block.vault.fall");
        VAULT_HIT = registerSound(helper, "block.vault.hit");
        VAULT_INSERT_ITEM = registerSound(helper, "block.vault.insert_item");
        VAULT_INSERT_ITEM_FAIL = registerSound(helper, "block.vault.insert_item_fail");
        VAULT_OPEN_SHUTTER = registerSound(helper, "block.vault.open_shutter");
        VAULT_PLACE = registerSound(helper, "block.vault.place");
        VAULT_REJECT_REWARDED_PLAYER = registerSound(helper, "block.vault.reject_rewarded_player");
        VAULT_STEP = registerSound(helper, "block.vault.step");
