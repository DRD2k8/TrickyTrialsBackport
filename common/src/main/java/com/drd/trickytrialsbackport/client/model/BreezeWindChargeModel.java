...
public class BreezeWindChargeModel extends EntityModel<BreezeWindCharge> {
    private final ModelPart bone;
    private final ModelPart wind;
    private final ModelPart windCharge;

    public BreezeWindChargeModel(ModelPart root) {
    ...
    @Override
    public void setupAnim(BreezeWindCharge entity, float limbSwing, float limbSwingAmount,
