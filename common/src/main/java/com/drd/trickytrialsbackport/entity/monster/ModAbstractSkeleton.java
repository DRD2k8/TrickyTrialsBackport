...
public abstract class ModAbstractSkeleton extends Monster implements RangedAttackMob {
    private final RangedBowAttackGoal<ModAbstractSkeleton> bowGoal = new RangedBowAttackGoal(this, 1.0, 20, 15.0F);
    private final MeleeAttackGoal meleeGoal = new MeleeAttackGoal(this, 1.2, false) {
        public void stop() {
            super.stop();
            ModAbstractSkeleton.this.setAggressive(false);
        }

        public void start() {
            super.start();
            ModAbstractSkeleton.this.setAggressive(true);
        }
    };

    protected ModAbstractSkeleton(EntityType<? extends ModAbstractSkeleton> entityType, Level level) {
